...
public class OrderReceiver {
    ...
    public void onOrderMessage(@Payload OperationLog operationLog, @Headers Map<String,Object> headers, Channel channel) throws IOException {
