package com.gaolong.aopdemo.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.gaolong.aopdemo.annotation.OperationLogDetail)")
    ...
    private void addOperationLog(JoinPoint joinPoint, Object res, long time){
        ...
        if(annotation != null){
            ...
            operationLog.setMethod(signature.getDeclaringTypeName() + "." + annotation.detail());
        }
        //TODO 这里保存日志
        System.out.println("记录日志:" + operationLog.toString());

        rabbitOrderSender.sendOrder(operationLog);
